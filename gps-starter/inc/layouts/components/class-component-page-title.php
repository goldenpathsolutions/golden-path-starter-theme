 ...
 *
 * Creates component styled as page title, H1 tag by default
 *
...
class Component_Page_Title extends Component {
	...
	public function __construct() {
		...
		while ( have_rows( 'component_page_title' ) ) : the_row();

			parent::add_common_attribute_classes();
			$this->classes[] = 'c-page-title';

			$tag = get_sub_field( 'semantic_heading_h1' );
